...
-   This article helps users with R and Python data analysis [@wallin2024].

-   This textbook helps with understanding the concepts of the Bradley-Terry Model as well as illustrating the code involved [@smith1BradleyTerryLuceModel].
