...
-   If it is greater \> 0.05, like it is for hoopsno.csv, the team's strength does not provide a strong enough effect to influence the result of the game.

-   If it is less, \> 0.05, the team's strength does provide a strong enough effect to influence the result of the game and can be used to predict outcomes.
